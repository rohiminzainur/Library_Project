            ...
            <div class="card-body">
                <form action="{{ route('books.store') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        @enderror" name="isbn" value="{{ old('isbn') }}" autofocus placeholder="Enter Isbn">
                    ...
                    <div class="form-group">
                        ...
                        @enderror" name="title" value="{{ old('title') }}" autofocus placeholder="Enter Title">
                    ...
                    <div class="form-group">
                        ...
                        @enderror" name="year" value="{{ old('year') }}" autofocus placeholder="Enter Year">
                    ...
                    <div class="form-group">
                        ...
                        @enderror" name="qty" value="{{ old('qty') }}" autofocus placeholder="Enter Qty">
                    ...
                    <div class="form-group">
                        ...
                        @enderror" name="price" value="{{ old('price') }}" autofocus placeholder="Enter Title">
